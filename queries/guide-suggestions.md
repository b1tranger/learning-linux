...
- suggestions?<br>
"1. never play with real data, unless you know what you're doing. (real data = data you care about, will regret if they're lost)
<br>2. always have backup
<br>and you're good to go"
- distro?<br>"you can also try fedora, as the godfather suggests fedora"
<br>can I customize ubuntu like arch?
...
- [storage locking issue](https://github.com/b1tranger/learning-linux/blob/main/queries/issues.md)
