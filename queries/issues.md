...
-  Prottoy: <br>"distro er (upor) depend kore, but 30gigs er moto rakhi ami always. of course amr needs er sathe match kore jonne."<br>can I not make partitions? I don't need any space for personal stuff<br>"you dont want to make partitions? you need at least 2 partition in efi mode, boot and the root"
- foxxie: <br>"tumi to manually kortaso, automatic koro nai keno? swap is optional, there should be an option for it to enable. there is no need for /tmp. it just stores temporary files that Linux creates. there are only two necessary mount points
<br>1. /boot
<br>2. /
<br>even /home is optional. /home is where your user accounts stay. the good thing is to backup /home regularly. it never helped to give /home separate space. i always ended up formatting the whole drive"
